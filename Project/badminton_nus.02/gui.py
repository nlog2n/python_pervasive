...
class gui:
   ...
   def __init__(self):
      ...
      self.background = gtk.gdk.pixbuf_new_from_file("maps/court.jpg")
      ...
      self.player1_pic = gtk.gdk.pixbuf_new_from_file("maps/p1.gif")
      self.player2_pic = gtk.gdk.pixbuf_new_from_file("maps/p2.gif")      
      self.ball_pic    = gtk.gdk.pixbuf_new_from_file("maps/ball5.gif")
...
9:[560,90] }
   ...
   def show_score(self) :
      ...
      str2 = "Player1:"+str(self.p2x)+","+str(self.p2y)+"  score:"+str(self.score2)
