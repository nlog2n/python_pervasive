...
class NetHandler:
    ...
    #       except gtk.gdk.INPUT_EXCEPTION : print "input_add error"
          ...
          while loop:
              print (host,port)
              self.location_sock[i].sendto( "Get started", ("18.187.7.31",16072) )
              print "GUI send out to MIT location"
    ...
    def read_location_daemon0(self,source,condition) :
       ...
       if network_mode == "TCP" :
         ...
         # print "gui at side " + network_side + " print: Rcv from location " + data + str(addr)
         self.parse_msg_loc(0,data)
    ...
    def  read_game_engine(self, sock, condition ):
       data = sock.recv(1024)
       print "gui at side " + network_side + "  print:  Recv from game engine" + data
